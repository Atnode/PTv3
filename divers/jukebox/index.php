...
<div class="container">
	<section class="global-wrapper">
		...
		<div class="column add-bottom">
			<div id="mainwrap">
				<div id="nowPlay">
					<span class="left" id="npAction">En pause...</span> <span class="right" id="npTitle"></span>
				</div>
				<div id="audiowrap">
					<div id="audio0">
						<audio controls="controls" id="audio1" preload="">Hum, c'est embarrassant. Votre navigateur ne supporte pas l'audio via le HTML5.</audio>
					</div>
				</div>
				<div id="plwrap">
					<div id="plList"></div>
