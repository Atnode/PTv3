...
switch($erreur) {
   case '403':
   echo '<center><h3>Que faîtes-vous ici ?<br /><br />Vous n’êtes pas autorisé à accéder à cette partie du site !</h3></center><div class="center"><br /><img style="max-height:200px" alt="Erreur" src="/assets/img/403.png"></div>';
   break;
   case '404':
   echo '<center><h3>Coup dur pour Toad...<br /><br />La page à laquelle vous essayez d’accéder est inexistante !</h3></center><div class="center"><br /><img alt="Erreur" src="/assets/img/404.png">&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   break;
   case 'rm':
   echo '<center><h3>Nous sommes triste...<br /><br />Mais cette fonctionnalité n’existe malheureusement plus !</h3></center><div class="center"><br /><img style="max-height:200px" alt="Erreur" src="/assets/img/sorry.png"></div>';
   break;
   default:
   echo '<center><h3>Hum, c’est embarrassant...<br /><br />Erreur inconnue.</h3></center><div class="center"><br /><img style="max-height:200px" alt="Erreur" src="/assets/img/sorry.png"></div>';
}
?>
</div>
